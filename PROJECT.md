...
**Course deliverables (outside the repo, in `Code/`):**
- `BaoCao_QLDA_KeHoachDuAn_Chatbot.docx`: PM report (IT Project Management). Follows
...
unreachable; PM handed over = CR00); seminar = project task 1.1.4 by [Thành viên 2],
[Thành viên 3] before they left; the developer = architect and main developer, PM after
the handover. Placeholders to fill in before submission: names, student IDs,
supervisor, Sprint 0 dates, CR00 date.
